...
@Composable
fun HostessScrollablePane(
    minHeight: Dp,
    maxHeight: Dp,
    testTag: String,
    modifier: Modifier = Modifier,
    contentPadding: PaddingValues = PaddingValues(HostessTheme.spacing.fieldGap),
                ...
                modifier = Modifier
                    ...
                    .padding(
                        ...
                        top = contentPadding.calculateTopPadding(),
                            ...
                            HostessPlatformUi.scrollbarContentInset,
...
object HostessPlatformUi {
    val scrollbarContentInset: Dp
        @Composable
        get() = if (HostessPlatformVisibleScrollbars) {
            HostessTheme.spacing.scrollbarWidth
        } else {
            HostessTheme.spacing.none
        }
}
