...
class VaultFileAccountProfileStore internal constructor(
    ...
    private fun GemVaultProfileRecord.toProfile(): SavedAccountProfile =
        SavedAccountProfile(profileId, loginName, label, credentialHandle, startLocation)

    private fun SavedAccountProfile.toVaultProfileRecord(): GemVaultProfileRecord =
        GemVaultProfileRecord(profileId, loginName, label, credentialHandle, startLocation)
}
