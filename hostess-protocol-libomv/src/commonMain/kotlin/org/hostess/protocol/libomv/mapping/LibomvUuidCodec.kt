...
internal object LibomvUuidCodec {
    const val ZERO_ID: String = "00000000-0000-0000-0000-000000000000"
    ...
    private fun parseBytes(value: String): ByteArray? {
        ...
        val hex = StringBuilder(ID_HEX_LENGTH)
    ...
    private fun format(bytes: ByteArray): String = buildString(ID_TEXT_LENGTH) {
    ...
    private const val ID_TEXT_LENGTH = 36
