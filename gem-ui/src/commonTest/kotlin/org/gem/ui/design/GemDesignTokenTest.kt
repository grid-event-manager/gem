...
class GemDesignTokenTest {
    ...
    fun typeScaleUsesFixedPrototypeSizes() {
        ...
        assertEquals(typeScale.body.fontSize, typeScale.fieldText.fontSize)
        assertEquals(typeScale.body.lineHeight, typeScale.fieldText.lineHeight)
        assertEquals(12.sp, typeScale.smallLabel.fontSize)
        assertEquals(typeScale.smallLabel.fontSize, typeScale.backLabel.fontSize)
        assertEquals(typeScale.smallLabel.lineHeight, typeScale.backLabel.lineHeight)
        assertEquals(typeScale.smallLabel.fontSize, typeScale.themeToggleLabel.fontSize)
        assertEquals(typeScale.smallLabel.lineHeight, typeScale.themeToggleLabel.lineHeight)
